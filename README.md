...
## Swift version
The latest version of Swift-cfenv works with the `DEVELOPMENT-SNAPSHOT-2016-04-12-a` version of the Swift binaries. You can download this version of the Swift binaries by following this [link](https://swift.org/download/).
